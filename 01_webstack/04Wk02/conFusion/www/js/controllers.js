...
.controller('DishDetailController', ['$scope', '$stateParams', 'menuFactory', 'favoriteFactory', 'baseURL', '$ionicLoading', '$ionicPopover', function($scope, $stateParams, menuFactory, favoriteFactory, baseURL, $ionicLoading, $ionicPopover) {
